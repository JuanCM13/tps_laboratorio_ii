...
namespace BookCloud_Vista
{
    public partial class Form_SeleccionDeCliente : Form , IComunes_Forms
    {
        ...
        /// <summary>
        /// Setea informacion por default, si el listado de clientes no cargo todavia, informa que reingrese en pocos segundos
        /// y setea el boton de agregar cliente en Enable false, asi no permite agregar clientes a una lista sin instanciar,
        /// al regresar si ya cargo la lista, habilita el boton.
        /// </summary>
        public void Setear_Datos()
        {
            if (!(this.ventas is null) && !(this.clientes is null))
            {
                this.Btn_AgregarCliente_SeleccionarCliente.Enabled = true;
            ...
            {
                this.Btn_AgregarCliente_SeleccionarCliente.Enabled = false;
                this.Lbt_Premium_SeleccionClientes.Items.Add("Cargando los clientes, salga y reingrese en unos segundos!");                    
            }
        }
